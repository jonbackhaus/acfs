...
# Create workspace and GTBI directories
install_base_filesystem() {
    ...
    if [[ "${DRY_RUN:-false}" != "true" ]] \
        ...
        log_info "base.filesystem already installed; skipping"
        return 0
    fi
